...
class AdminKit_Integration_Woocommerce extends AdminKit_Integration_Base {
	...
	public static function register_assets() {
		...
		AdminKit_Assets::register( array(
			...
			'src'       => 'inc/integrations/plugins/woocommerce/css/wc-admin.css',
		...
		AdminKit_Assets::register( array(
			...
			'src'       => 'inc/integrations/plugins/woocommerce/css/admin.css',
			'deps'      => array( AdminKit_Assets::TOKENS_HANDLE ),
			'context'   => 'admin',
		...
		AdminKit_Assets::register( array(
			...
			'src'       => 'inc/integrations/plugins/woocommerce/css/select2.css',
			'deps'      => array( AdminKit_Assets::TOKENS_HANDLE ),
			'context'   => 'admin',
		...
		AdminKit_Assets::register( array(
			...
			'src'       => 'inc/integrations/plugins/woocommerce/css/dashboard.css',
			'deps'      => array( AdminKit_Assets::TOKENS_HANDLE ),
			'context'   => 'admin',
