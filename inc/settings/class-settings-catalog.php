...
class AdminKit_Settings_Catalog {
	...
	public static function integration_specs() {
		...
		$labels = array(
			...
			'funnelkit-automation' => 'FunnelKit Automation',
	...
	private static function integration_host_files() {
		return array(
			...
			'funnelkit-automation' => array( 'wp-marketing-automations/wp-marketing-automations.php', 'wp-marketing-automations-pro/wp-marketing-automations-pro.php' ),
