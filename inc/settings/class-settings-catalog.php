...
class AdminKit_Settings_Catalog {
	...
	private static function integration_host_files() {
		return array(
			...
			'fluent-boards'     => array( 'fluent-boards/fluent-boards.php', 'fluent-boards-pro/fluent-boards-pro.php' ),
			...
			'fluent-security'   => array( 'fluent-security/fluent-security.php' ),
			'fluent-smtp'       => array( 'fluent-smtp/fluent-smtp.php' ),
			'fluent-support'    => array( 'fluent-support/fluent-support.php', 'fluent-support-pro/fluent-support-pro.php' ),
