	...
	private static function boot_data() {
		...
		return array(
			...
			'i18n'         => array(
				...
				'logoHint'          => __( 'Optional brand logo URLs (light + dark). Used for the brand mark by the site title and the Bricks builder. Leave empty to fall back to the adminkit/brand_logo filter.', 'adminkit' ),
