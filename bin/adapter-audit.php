...
$BUDGET = array(
	...
	'wp-migrate-db-pro' => 6,
	'fluentform'        => 2,
	'acf'               => 10, // ACF forces !important on btn labels, postbox titles, open-field handle links, field-type picker option states + options-page dropdown border (hex col = #acf-* id selectors, not colors)
);
